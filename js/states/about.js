...
"(Bilal continued): dialog system, map editor, power meter, enemy AI, particles, save and load, Zareem and Guru body, Taja faces, assorted improvements and fixes",
...
function aboutSetup() {
    ...
    var fontStr = (11 * pixelSize).toString() + "px " + uiContext.fontFamily;

    labelGroup = [];
    // labelGroup.push(new Label(tr(), "Developed by Members of HomeTeam GameDev (Outpost)", fontStr));

    for(var i=0;i<creditsList.length;i++) {
        labelGroup.push(new Label(tr(), creditsList[i], fontStr));
    }
